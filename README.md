...
```
lake clean && lake exec cache get && lake build ; patchelf --set-rpath $HOME/.elan/toolchains/leanprover--lean4---v4.29.0-rc6/lib/lean .lake/packages/mathlib/.lake/build/lib/libmathlib_Mathlib.so && patchelf --set-rpath $HOME/.elan/toolchains/leanprover--lean4---v4.29.0-rc6/lib/lean .lake/packages/importGraph/.lake/build/lib/libimportGraph_ImportGraph.so && lake build
```
Without cleaning:
```
lake build ; patchelf --set-rpath $HOME/.elan/toolchains/leanprover--lean4---v4.29.0-rc6/lib/lean .lake/packages/mathlib/.lake/build/lib/libmathlib_Mathlib.so && patchelf --set-rpath $HOME/.elan/toolchains/leanprover--lean4---v4.29.0-rc6/lib/lean .lake/packages/importGraph/.lake/build/lib/libimportGraph_ImportGraph.so && lake build
```